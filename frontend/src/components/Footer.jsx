  ...
  return (
    <footer className=" text-white bg-neutral-900 py-8 -m-8 mt-16 ">
        ...
        <div className="flex gap-12  mt-8 items-center justify-center">
          ...
          <a
            href="https://www.linkedin.com/in/abhijeetiitp/"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="flex justify-center  items-center mt-4">
          ...
          &nbsp; by{" "}
          <a className="p-2 hover:text-red-600" href="https://github.com/Abhi-Jeeet">
            Abhijeet
          </a>
        </div>
        <div className="flex justify-center items-center">
          &copy; {new Date().getFullYear()} RoomEase. All rights reserved.
        </div>
        </div>
        <div className="text-[10rem] font-bold flex justify-center p-10 items-center mt-10">
          Room<span className="text-[#7F00FF]">Ease</span>
        </div>
    </footer>
  );
}
